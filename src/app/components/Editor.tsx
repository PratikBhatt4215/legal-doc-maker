...
//  const [tableFit, setTableFit] = useState("auto");
...
// let html = `<table border='1' style='${tableStyle}'>`;

//   for (let r = 0; r < tableRows; r++) {
//     html += "<tr>";

//     for (let c = 0; c < tableCols; c++) {
//       html += "<td style='padding:8px; min-width:60px; word-break:break-word; overflow-wrap:break-word;'>&nbsp;</td>";
//     }
...
//             ref={docxRef}
//             className={`legal-doc-container ${perfectAlign ? "perfect-left-align" : ""}`}            style={{
